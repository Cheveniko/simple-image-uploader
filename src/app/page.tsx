...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col justify-between gap-y-4 bg-gradient-to-br from-[#efefbb] to-[#d4d3dd] pb-4 pt-20">
      ...
      <div className="space-y-1">
        <p className="text-center">
          Built by{" "}
          <a
            href="https://twitter.com/Cheveniko"
            target="_blank"
            className="transition-all hover:underline"
          >
            @Cheveniko 🇪🇨
        ...
        <a
          href="https://svelte-image-uploader.vercel.app/"
          target="_blank"
          className="mx-auto flex w-fit items-center justify-center gap-x-2 text-center hover:underline"
        >
          Svelte version
          <svg
            viewBox="0 0 256 308"
